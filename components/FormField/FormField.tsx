...
export default forwardRef<TextInputProps, FieldProps>(({title, required, inputType, submitPressed, inputProps}, ref) => {
    ...
    return(
        <View style={styles.formField} >
            ...
            {inputType === "text" && <CustomTextInput {...inputProps as CustomTextInputProps} borderColor={borderColor} setValue={setValueCallback} />}
            {inputType === "dropdown" && <Dropdown {...inputProps as DropdownProps} type={title.toLowerCase()} borderColor={borderColor} setValue={setValueCallback} />}
        </View>
    );
});
